The goal of this project is to create a video and audio streaming platform with user accounts and streaming history. Here's an overview of the techstack:
